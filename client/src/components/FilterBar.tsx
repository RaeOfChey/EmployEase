        ...
        <Form className="filter-bar custom-filter-bar" onSubmit={handleFormSubmit}>
            <Row className="filter-bar-row">
                <Col xs={12} md={3}>
                    ...
                    <DropdownButton
                        title={location.length === 1 ? 'Select location' : `${location.length - 1} selected`}
                    ...
                    >
                        {locationOptions.map((loc) => (
                            <Form.Check
                                ...
                                onChange={(e) => handleCheckboxChange(e, setLocation, location)}
                            />
                        ))}
                    </DropdownButton>
                </Col>
                ...
                <Col xs={12} md={3}>
                    ...
                    <DropdownButton
                        title={industry.length === 1 ? 'Select industry' : `${industry.length - 1} selected`}
                    ...
                    >
                        {industryOptions.map((ind) => (
                            <Form.Check
                                ...
                                onChange={(e) => handleCheckboxChange(e, setIndustry, industry)}
                            />
                        ))}
                    </DropdownButton>
                </Col>
                ...
                <Col xs={12} md={3}>
                    ...
                    <DropdownButton
                        title={experience.length === 1 ? 'Select experience level' : `${experience.length - 1} selected`}
